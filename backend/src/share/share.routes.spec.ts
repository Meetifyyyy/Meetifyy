...
describe('share routes', () => {
  ...
  describe('the three paths do not shadow one another', () => {
    ...
    it('serves a full 1080x1920 story canvas at /story.jpg', async () => {
      ...
      // Small enough to finish downloading before somebody taps the button —
      // see the encode comment in renderStory.
